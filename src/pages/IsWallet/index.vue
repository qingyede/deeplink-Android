<template>
  <div class="px-[16px]">
    ...
    <!-- 创建按钮 -->
    <div class="mt-[80px] flex flex-col gap-3">
      <n-button
        @click="router.push({ name: 'creatWallet' })"
        type="primary"
        class="flex-[1] rounded-lg min-h-[52px] text-[20px]"
        >{{ $t('IsWallet.createNewWallet') }}</n-button
      >
      <n-button
